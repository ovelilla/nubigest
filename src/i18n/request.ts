...
export default getRequestConfig(async ({ requestLocale }) => {
  ...
  ...(await import(`@/app/[locale]/(public)/messages/${locale}.json`)).default,
  ...
  ...(await import(`@/app/[locale]/(protected)/(pages)/user/settings/(pages)/accounts/messages/${locale}.json`)).default,
  ...
  ...(await import(`@/app/[locale]/(protected)/(pages)/user/settings/(pages)/sessions/messages/${locale}.json`)).default,
};
