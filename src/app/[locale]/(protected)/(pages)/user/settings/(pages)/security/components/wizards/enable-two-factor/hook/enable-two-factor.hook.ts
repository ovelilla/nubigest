...
// Types
import type { EnableTwoFactorHookProps } from "./types/enable-two-factor.hook.types";

const EnableTwoFactorHook = ({ onOpenChange }: EnableTwoFactorHookProps) => {
  ...
  const t = useTranslations(
    "securitySettings.components.wizards.enableTwoFactor",
  );
