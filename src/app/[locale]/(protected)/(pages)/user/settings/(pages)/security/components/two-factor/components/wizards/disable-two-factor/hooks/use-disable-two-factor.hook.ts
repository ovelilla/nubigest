...
// Types
import type { UseDisableTwoFactorProps } from "./types/disable-two-factor.hook.types";

const useDisableTwoFactor = ({ onOpenChange }: UseDisableTwoFactorProps) => {
