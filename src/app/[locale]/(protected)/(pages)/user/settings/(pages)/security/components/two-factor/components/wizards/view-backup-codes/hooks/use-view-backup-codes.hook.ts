...
// Types
import type { UseViewBackupCodesProps } from "./types/view-backup-codes.hook.types";

const useViewBackupCodes = ({
  onOpenChange,
  open,
}: UseViewBackupCodesProps) => {
  ...
  const t = useTranslations(
    "securitySettings.components.twoFactor.components.wizards.viewBackupCodes",
  );
