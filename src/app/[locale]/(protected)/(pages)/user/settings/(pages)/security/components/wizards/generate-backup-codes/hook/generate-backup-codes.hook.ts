...
// Types
import type { GenerateBackupCodesHookProps } from "./types/generate-backup-codes.hook.types";

const GenerateBackupCodesHook = ({
  onOpenChange,
}: GenerateBackupCodesHookProps) => {
  ...
  const t = useTranslations(
    "securitySettings.components.wizards.generateBackupCodes",
  );
...
export { GenerateBackupCodesHook };
