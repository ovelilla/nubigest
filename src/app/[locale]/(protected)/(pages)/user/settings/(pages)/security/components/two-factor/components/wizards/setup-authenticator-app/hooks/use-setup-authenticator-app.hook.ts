...
// Types
import type { UseSetupAuthenticatorAppProps } from "./types/setup-authenticator-app.hook.types";

const useSetupAuthenticatorApp = ({
  onOpenChange,
}: UseSetupAuthenticatorAppProps) => {
...
export { useSetupAuthenticatorApp };
